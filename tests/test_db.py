...
class TestTimelinePost(unittest.TestCase):
    ...
    def tearDown(self):
        # Not strictly necessary since SQLite in-memory databases only live for
        # the duration of the connection, and in the next step we close the 
    ...
    def test_get_time_line_post(self):
        ...
        first_post_data = data['timeline_posts'][0]
        ...
        second_post_data = data['timeline_posts'][1]
